...
namespace ConsultarDatos.Controllers.ObtenerDatos.V2
{
    ...
    public class DatosPersonaController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetDatosPersona(string cedula)
        {
            ...
            var licenciaData = await _datosLicencia.ConsultarDatosLicenciaV2(cedula);
            ...
            var persona = new DatosPersonaModelV2Dto
            {
                ...
                Discapacidad = licenciaData.Discapacidad,
                FechaMatrimonio = licenciaData.FechaMatrimonio,
                Ocupacion = licenciaData.Ocupacion,
                Puntos = licenciaData.Puntos,
